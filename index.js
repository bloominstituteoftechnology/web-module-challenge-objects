...
*/
console.log('task1b', creatMenuItem('piza', 5, 'Lunch'));
console.log('task1b', creatMenuItem('waffles', 10, 'Brunch'));
  console.log('task1b', creatMenuItem('chocolate milkshake', 6, 'Drinks'));
