...
console.log(createMenuItem("Alfredo Pasta", 10, "Dinner"));
...
export const burger = {
  ...
  category: "Lunch", 
  /*Your code here*/
  discount: function(customerDiscount) {
    if (customerDiscount = "teacher" || "student") {
      return 18 * .75;
    }
    else if (customerDiscount = "public"){
      return 18 * 0.9;
    }
    else {
      return 18;
...
*/
reviews.push({name: "Fonz", rating: 5, feedback: "Delicious vegan food and various options, would come back again"})
console.log(reviews);
