...
*/
reviews.push({name:'Destiny', rating:6,feedback:'not terrible but not amazing'})
console.log(reviews);
...
function getReviewByIndex(reviews,index) {
  return(`${reviews[index.name]}${reviews[index.rating]} and their feedback was ${reviews[index].feedback}`)
}
