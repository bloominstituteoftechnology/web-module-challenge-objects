...
console.log(createMenuItem('tacos', 8, 'Lunch'));
console.log(createMenuItem('beacon', 5, 'breakfast'));
console.log(createMenuItem('Chicken', 15, 'Dinner'));
...
const burger = {
  ...
  category: "Lunch", 
  /*Your code here*/
  discount: function(specials) {
    if(specials === 'teacher' || specials === 'student'){
...
reviews.push({
  name: 'Vida', 
  rating: 4.5, 
  feedback: "You are awesome! You did right"
})
console.log(reviews);
...
reviews[7].feedback = "The servers are awesome";
console.log(reviews);
