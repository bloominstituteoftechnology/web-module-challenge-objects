...
console.log('task 1a', createMenuItem('spaghetti', 5, 'dinner'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 1b: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
*/
console.log('task 1a', createMenuItem('hot dog', 2, 'lunch'));
console.log('task 1a', createMenuItem('pizza', 4, 'breakfast'));
console.log('task 1a', createMenuItem('french fries', 3, 'lunch'));
...
function addReview(name, rating, feedback){
  reviews.push(name 'Daniela', rating 5, feedback 'Beautiful atmosphere and wonderful vegain options!'
}
...
console.log('task6', getReviewByIndex, 2));
