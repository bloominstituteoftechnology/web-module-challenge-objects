...
console.log('task 1b', createMenuItem('spaggetti', 10, 'dinner'));
console.log('task 1b', createMenuItem('crispy brussel sprouts', 7, 'dinner'));
...
Use the getLastReview function below to do the following:
  ...
  For example: getLastReview(reviews) would return: " this place is chill with really cool people, great for getting work done on weekdays".
