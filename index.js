...
console.log(createMenuItem('Milkshake', 5, 'Drinks'));
...
discount: function(string) {
  if (string === 'teacher') {
    discountPrice = (burger.price - (burger.price * .25));
  } else if (string === 'student') {
    discountPrice = (burger.price - (burger.price * .25));
  } else if (string === 'public') {
    discountPrice = (burger.price - (burger.price * .10));
  } else {}
...
reviews.push({name: "Tim", rating: 5, feedback: "I just wish the food wasn't virtual."});
console.log(reviews);
