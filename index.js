...
function createMenuItem(name, price, category){
  ...
  console.log(createMenuItem('Tacos', '18', 'lunch'))
...
console.log(createMenuItem('Petit-Fours', '4', 'cakes'))
...
const burger = {
  ...
  price: "18", 
  category: "Lunch", 
  discount: [{ teacher:  "13.50",
               student: "16.20",
               public: "18.00"     }]
}

console.log(burger.discount[0].public)
...
function getReviewByIndex(name, rating, feedback) {
  ...
  console.log(getReviewByIndex(reviews[0].name))
console.log(getReviewByIndex(reviews[0].rating))
console.log(getReviewByIndex(reviews[0].feedback))
