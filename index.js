...
function getReviewByIndex(array, number) {
  let indexReviews = `${array[number].name} gave the restaurant a ${array[number].rating} star review, and their feedback was: ${array[number].feedback}`;
  return indexReviews
}
