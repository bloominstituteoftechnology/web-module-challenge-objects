...
console.log(createMenuItem(name : 'tacos', price: 8, category: 'lunch'))
...
reviews.push(name: 'abdiel', rating: 0, feedback: 'i dont get this')
...
function getReviewByIndex(review,0) {
