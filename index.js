...
function createMenuItem(name, price, category){
  return name = {name, price, category};
}
...
console.log(createMenuItem("pizza", 12, "lunch/dinner"));
console.log(createMenuItem("pasta", 10, "lunch/dinner"));
console.log(createMenuItem("salad", 8, "lunch/dinner"));
...
*/
reviews.push({name:"Collin", rating:4, feedback:"I thought it was just okay"})
console.log(reviews);
...
function getReviewByIndex(array, index, name, rating, feedback) {
...
function getLastReview(array, i, name, rating, feedback) {
  i = array.length - 1;
 ...
 function getReviewByRating(array, stars) {
   const ratingArr = [];
    for(let i = 0; i < array.length; i++){
      if(Math.floor(array[i].rating) === Math.floor(stars)){
