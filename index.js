...
console.log(createMenuItem("yogurt", 8, "Breakfast" ));
...
discount: function(string) {
  if (string.includes("public", "student")) {
    return this.price - (this.price * .33);
  }
  else if (string.includes("teacher")) {
...
reviews.push({name:"Ben", rating: 3.5, feedback "it was eh"},);
console.log(reviews);
