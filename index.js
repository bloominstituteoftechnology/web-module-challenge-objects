...
const reviews = [
    ...
    {name: "Reyna", rating: 3.5, feedback: "Reyna gave the restaurant a 3.55 star review, and their feedback was: this place is chill with really cool people, great for getting work done on weekdays!"},
]
...
*/
 reviews.push(name: "Jacob", rating: 10, feedback: "An absolute beauty.");
 log(reviews);
...
*/
reviews(reviews.push[ reviews.length 6 === 'this place is chill with really cool people, great for getting work done on weekdays']);
log(reviews);
...
function getReviewByIndex(reviews[4]) {
  return `${this.name} gave the resturant a ${this.rating} star review, and their feedback was: ${this.feedback}`
}

log(getReviewByIndex);
...
*/
 ...
 function getReviewByRating(reviews, 4) {
    return 
  }
