...
*/
const duck = createMenuItem('Roast Duck L\'orange', 28, 'Dinner');
const veggie = createMenuItem('Beet Salad', 34, 'Brunch');
const beef = createMenuItem('Kobe beeftips', 235, 'Appetizer');

console.log(duck, veggie, beef);
...
*/
reviews.push({name: "Brandon", rating: 5, feedback:"It had Korean BBQ!"})
console.log(reviews)
...
function getLongReviews(array) {
    ...
    for (let i = 0; i < array.length; i++) {
      let words = array[i].feedback.split(" ").length
      if (words > 15) {
        new_array.push(array[i])
      }
    }
