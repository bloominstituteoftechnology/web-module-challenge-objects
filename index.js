...
let menuItemOne = createMenuItem('tacos', 8, 'Lunch');
...
let menuItemTwo = createMenuItem('pizza', 5, 'Lunch');
let menuItemThree = createMenuItem('Ice Cream', 7, 'Dessert');
let menuItemFour = createMenuItem('Chicken Tenders', 8, 'Dinner');

console.log(menuItemTwo);
console.log(menuItemThree);
console.log(menuItemFour);
...
*/
reviews.push({name: "Aidan", rating: 4, feedback: "Did well"});
console.log(reviews);
