...
const pasta = createMenuItem("pasta", 12, "dinner");
console.log(pasta);
const soup = createMenuItem("soup", 8, "lunch");
console.log(soup);
const icecream = createMenuItem("icecream", 5, "dessert");
