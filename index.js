...
console.log(createMenuItem('Omllete',15,'breakfast'));
...
console.log(createMenuItem('sandwich',7,'breakfast'));
...
const madeup = {name: "Fictitioo", rating: 4.9, feedback:"fun and lots of excitment!"}
