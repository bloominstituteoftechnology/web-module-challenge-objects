...
console.log(createMenuItem("burger T",11,"lunch"))
console.log(createMenuItem("EggMonre",8,"breakfast"))
...
*/
reviews.push("Markel", 4,"I waited very long for my food ,but the food was delicious.");
console.log(reviews);
