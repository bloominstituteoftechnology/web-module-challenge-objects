...
console.log(createMenuItem('Hot Fudge Sundae', 10, 'Dessert'));
...
function getReviewByIndex(array, indexNumb) {
  return (`${array[indexNumb].name} gave the restaurant a ${array[indexNumb].rating} star review, and their feedback was: ${array[indexNumb].feedback}`);
}
