...
*/
console.log(createMenuItem('slice', 3, 'lunch'));
console.log(createMenuItem('whole pie', 21, 'dinner'));
console.log(createMenuItem('sub', 8, 'lunch'));
...
*/
reviews.push({name:'Lara', rating:5, review:'I loved the hot chocolate and board games. I highly recommend this little hipster heaven'})
