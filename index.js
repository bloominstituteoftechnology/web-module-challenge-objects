...
function createMenuItem( name, price, category) {
  var createItem = { name, price, category };
...
*/
createMenuItem("etherium", 2766, "cryptocurrency");
createMenuItem("dogecoin", .3, "cryptocurrency");
createMenuItem("bitcoin", 53579, "cryptocurrency");
...
export const burger = {
  ...
  price: 18,
  category: "Lunch",
  discount: function burgerSpecial(customer) {
    if (customer === 'teacher') {
      return 13.5;
    }
...
function getReviewByIndex(reviewArray, getIndex) {
  var answer =
    reviewArray[getIndex].name +
    " gave the restaurant a " +
    reviewArray[getIndex].rating +
    " star review, and their feedback was: " +
    reviewArray[getIndex].feedback;
  return answer;
}
