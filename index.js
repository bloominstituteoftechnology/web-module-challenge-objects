...
reviews.push({name: 'Jeremy', rating: 2.5, feedback: 'Trying to understand JavaScript'});
...
// let getReview = getLastReviews(review); //Making a backup of your function with the object and array
