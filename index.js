...
*/
const omelette = createMenuItem('omelette', 10, 'breakfast');
const yogurt = createMenuItem('yogurt', 3, 'breakfast'); 
const oatmeal = createMenuItem('oatmeal', 5, 'breakfast');
console.log(oatmeal, yogurt, omelette);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
*/
reviews.unshift({name: 'Diego', rating: 5, feedback:"Yo this place is pretty dope, I'd come here again."});
console.log(reviews);
...
function getLastReview(arr) {
  ...
  const rating = arr[arr.length-1].rating
  const feedback = arr[arr.length-1].feedback
