...
*/
reviews.push({name: 'Colton', rating: 5, feedback: 'Awesome'})
...
console.log('task 5:', addReview(reviews, 'Colton', 5, 'awesome'));
...
function getReviewByIndex(array, number) {
  return `${array[number].name} gave the restraunt a ${array[number].rating} star review,
...
function getLastReview(array) {
  return `${array[array.length -1].name} gave the restraunt a ${array[array.length -1].rating}
  star rating, and their feedback was: ${array[array.length -1].feedback}`;
} 
