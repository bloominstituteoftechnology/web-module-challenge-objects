...
console.log(createMenuItem("egg",1,"breakfast")) ;
console.log(createMenuItem("rice",2,"lunch")) ;
console.log(createMenuItem("BBQ",3,"dinner")) ;
...
export const burger = {
  ...
  discount: function(status) {
    if (status = "teacher" || "student") {
      return this.price = 18 * 0.75;
      }
    else {
      return this.price = 18 * 0.90;
    }
  } 
}
...
*/
reviews.push({name: "Karen", rating: 1, feedback: "Manager won't give us free food!"})
console.log(reviews);
