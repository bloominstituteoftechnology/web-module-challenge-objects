...
console.log(createMenuItem("carne asada fries", 10, "Lunch&Dinner"))
console.log(createMenuItem("Burrito", 7, "Lunch&Dinner"))
console.log(createMenuItem("Big Burrito", 11, "Lunch&Dinner"))
...
export const burger = {
  ...
  category: "Lunch", 
  /*Your code here*/
  discount: function(discounts) {
    if(discounts === "teacher" || discount === "student"){
      return this.price * .75;
    }
    else if (discounts === "public"){
      return this.price * .9;
    }
  }
}

conjsole.log(burger.discount("student"))
...
*/
reviews.push({name:"Jacob", rating: 5, feedback:"What is Life"})
console.log(reviews)
...
function getReviewByIndex(anArray, indexNum) {
     return "${anArray[indexNum].name} gave the restaurant a ${anArray[indexNum].rating} star review, and their feedback was: ${anArray[indexNum].feedback}";
}
