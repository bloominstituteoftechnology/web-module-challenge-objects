...
*/
const b = { name: "asia", rating: 4, feedback:"great"};
console.log (reviews.push(b))
...
function getReviewByIndex(arrayOfReviews, x) {
  let answer = "";
  answer = 
    arrayOfReviews[x]['name'] + 
    " gave the restaurant a " + 
    arrayOfReviews[x]['rating'] + 
    " star review, and their feedback was: " +
    arrayOfReviews[x]["feedback"];
  return answer;
}
...
function getLastReview(reviews) {
  ...
  return getReviewByIndex(reviews, index);
} 
