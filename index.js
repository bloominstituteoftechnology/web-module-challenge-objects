...
const cake = createMenuItem('cake', 2, 'dessert');
const dog = createMenuItem('dog', 1, 'gross');
const cat = createMenuItem('cat', 1, 'gross');
...
burger.discount= function(stg){
  return (stg === 'teacher' || stg === 'student') ? this.price * .75 : this.price * .9;
}
...
reviews.push({name:"Jacob", rating: 0, feedback: 'gross'});
console.log(reviews);
