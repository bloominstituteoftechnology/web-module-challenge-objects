...
let menuItem1 = createMenuItem('pizza', 1.50, 'Snack')
console.log (menuItem1)

let menuItem2 = createMenuItem('cake', 5, 'Dessert')
console.log (menuItem2)

let menuItem3 = createMenuItem('hamburger', 10, 'Dinner')
...
let burgerDiscount = burger.discount('public')
console.log(burgerDiscount)
...
reviews.push({name: "Debra", rating: 5, feedback: "yummy"});
console.log (reviews);
...
for (let i=0; i<reviews.length -1; i++){
  ...
  reviews[i].feedback = "this place is chill with really cool propole, great for getting work done on weekdays"
  }
...
function getLastReview(arr) {
  let lastReviewIndex = arr.length-1

  let review = arr[lastReviewIndex]
return review.name + " gave the restaurant a "+ review.rating +" star review, and their feedback was " + review.feedback;
 }
