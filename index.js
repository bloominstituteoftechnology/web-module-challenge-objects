...
*/
createMenuItem("Scrambled Eggs", 3, "Breakfast")
createMenuItem("Grilled Chicken", 11, "Lunch")
createMenuItem("Steak", 18, "Dinner")
...
burger.discount =
  function(discprice) {
  if (discprice === "teacher") {
    return this.price * .75;
  }
  if (discprice === 'student') {
    return this.price * .75;
  }
  if (discprice === 'public') {
