...
function createMenuItem(itemName, itemPrice, bookmark){
    /*Your code here*/
    const newObject = {name:itemName, price: itemPrice, category: bookmark };
    return newObject;
}
...
console.log(createMenuItem("Coffee", 6, "drink"));
console.log(createMenuItem("Latte", 6, "drink"));
