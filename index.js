...
reviews.push(){
  name: "Alexander", Raiting: 5, feedback: "More Chicky Nuggies";
}
...
eviews[7].feedback = "this place is chill with really cool people, great for getting work done on weekdays";
console.log(reviews);
