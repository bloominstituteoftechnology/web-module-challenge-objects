...
console.log(createMenuItem("stawberries", 4, "Fruit"))
console.log(createMenuItem("chicken tenders", 8, "Dinner"))
console.log(createMenuItem("ice cream", 3, "Dessert"))
...
function addReview (arr, name, rating, feedback) {
  ...
  console.log(addReview(reviews, "Nasha", 5, " My steak was amazing"))
