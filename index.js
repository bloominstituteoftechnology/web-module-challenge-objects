...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function discount(para){
    if (para === "teacher" || para === "student"){
...
console.log(this.push(newObject));
...
function getLastReview(arr){
  return `${arr.name[arr.length-1]} gave the restaurant a ${arr.rating[arr.length-1]} star review, and their feedback was: ${arr.feedback[arr.length-1]}`
