...
*/
let menuItem1 = createMenuItem('bacon', 3, 'breakfast');
let menuItem2 = createMenuItem('burger', 5, 'lunch');
let menuItem3 = createMenuItem('steak', 9, 'dinner');
...
reviews.push({name: "Casey", rating: 4, feedback: "new feedback."})
