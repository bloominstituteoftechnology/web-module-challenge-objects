...
*/
console.log(createMenuItem("Rootbeer", 2, "Lunch"));
console.log(createMenuItem("Latte", 6, "Breakfast"));
console.log(createMenuItem("Adult Bev", 9, "Dinner"));
...
export const burger = {
  ...
  category: "Lunch", 
  discount: (string) => {
    let newPrice = burger.price;
    if (string === "student" || string === "teacher") {
      return newPrice * 0.75;
    } else {
      return newPrice * .90;
    }
  }
...
const fakeReview = {name: "Elon", rating: 10, feedback: "To the Moon"};
console.log(reviews.push(fakeReview));
...
let getReviewByIndex = (array, index) => {
...
let getLastReview = array => `${array[array.length - 1].name} gave the restaurant a ${array[array.length - 1].rating} star review, and their feedback was: ${array[array.length - 1].feedback}`;
