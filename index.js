...
console.log(createMenuItem("Poke Bowls", 15, "Lunch"))
...
console.log(addOpinion(reviews, "Andrew", 4, "It's ok, I guess."))
...
newFeedback(reviews, "Reyna", "This place is chill with really cool people, great for getting work done on weekdays");
console.log(reviews);
